 ...
 * License: MIT
 *
 * Generated at Wednesday, September 30th, 2015, 10:55:30 AM
 */
(function() {
'use strict';
...
crop.factory('cropAreaRectangle', ['cropArea', function(CropArea) {
  ...
  CropAreaRectangle.prototype._isCoordWithinArea=function(coord) {
    var squareDimensions=this._calcRectangleDimensions();
...
crop.directive('imgCrop', ['$timeout', 'cropHost', 'cropPubSub', function($timeout, CropHost, CropPubSub) {
  return {
    ...
    link: function(scope, element/*, attrs*/) {
      ...
      // Init Crop Host
      var cropHost=new CropHost(element.find('canvas'), options, events);
